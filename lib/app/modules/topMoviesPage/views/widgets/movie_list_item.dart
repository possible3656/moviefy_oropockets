...
class MovieListItem extends GetView<TopMoviesPageController> {
  ...
  const MovieListItem(this.moviesDetailsModel, {Key? key, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: (() => controller.onMoviePressed(index)),
        child: Container(
          height: 200,
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(
                              'https://image.tmdb.org/t/p/w780${moviesDetailsModel.results[index].backdropPath}'),
                          fit: BoxFit.cover),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                moviesDetailsModel.results[index].title,
                                maxLines: 3,
